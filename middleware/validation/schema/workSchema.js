...
const workSchema = {
  work: joi.object({
    ...
    employer_kafeel: joi
      .string()
      .min(2)
      .message("من فضلك ادخل جهةالعمل للكفيل بشكل صحيح")
      .required()
      .max(100)
      .message("من فضلك  ادخل جهة العمل للكفيل اقل من 100 حرف")
    ,
    ...
    other_source_of_income_kafeel: joi
      .string()
      .min(2)
      .message("من فضلك ادخل مصدر الدخل الاخر للكفيل بشكل صحيح")
      .max(100)
      .message("من فضلك  ادخل معدل الدخل الشهري اقل من 100 حرف"),
    other_income_value_kafeel: joi
      .string()
      .min(2)
      .message("من فضلك ادخل قيمة الدخل الاحر للكفيل بشكل صحيح")
      .max(100)
      .message("من فضلك  ادخل معدل الدخل الشهري اقل من 100 حرف"),
    is_daman_kafeel: joi
      .string()
      .min(2)
      .message("من فضلك حدد ان كان الكفيل خاضعا للضمان او لا")
      .required()
      .max(100)
      .message("من فضلك  حدد ان كان الكفيل خاضعا للضمان او لا")
    ,
